      ...
      <form  action="payscript.php" method="post" style="padding: 25px;">
        ...
        <div class="row" >
          ...
          <div class="col-25">
            ...
            <input type="text" id="fname" name="name" placeholder="peter">

            <label for="email"><i class="fa fa-envelope"></i> Email</label>

            <input type="text" id="email" name="email" placeholder="peter@example.com">

            <input type="hidden" value="<?php echo 'OID'.rand(100,1000);?>" name="orderid">

            <input type="hidden" value="<?php echo 30000;?>" name="amount">
